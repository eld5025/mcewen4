class DrawingsController < ApplicationController
  ...
  def index
    ...
    # @drawings = Drawing.search(params[:search])
  ...
  def destroy
   ...
   def import
    Drawing.import(params[:file])
    redirect_to drawings_path, notice: "Drawings Successfully added"
  end
  ...
  private
    ...
    def drawing_params
      params.require(:drawing).permit(:newdrawing, :olddrawing, :year, :description, :width, :length, :shape, :subset, :step, :widthinches, :lengthinches, :brand)
    end
end
